...
const DEFAULT_INBOUND_PATH = `${workspaceRoot()}/inbound.db`;
const DEFAULT_OUTBOUND_PATH = `${workspaceRoot()}/outbound.db`;
const DEFAULT_HEARTBEAT_PATH = `${workspaceRoot()}/.heartbeat`;
